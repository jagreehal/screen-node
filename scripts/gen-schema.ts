// Generate screen.schema.json from the zod schema (the single source of truth).
...
const out = path.resolve(path.dirname(fileURLToPath(import.meta.url)), '..', 'screen.schema.json');
